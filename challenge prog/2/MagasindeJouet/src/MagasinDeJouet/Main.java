...
public class Main {
	...
	public static void main(String[] args) {
		...
		jouets.add(new Jouet("Lu Garu",15,"Jeu avec pleins de rôles",10));
		jouets.add(new Jouet("Zebre Figurine",6,"Super figurine de Zèbre",5));
		jouets.add(new Jouet("Osobot Evo",70,"Robot pour apprendre à programmer",15));
